...
# get serveral pics per occurrence * only the known ones to strengthen the recognization
# need to be guided by admin when adding strangers
# send back to rpi per period* 
# period* duration is 1500s of course can be changed
import cv2
import numpy as np
...
while True:
    ...
    if new_t % 1500 == 0:
        ...
        if os.path.isfile(filedir):
            ...
            file_msg = {"action": "put", "name": file_name, "size": file_size}  # build json
